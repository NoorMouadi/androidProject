...
public class ExpensesFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btnAddExpense.setOnClickListener(v -> showAddDialog());

        listExpenses.setOnItemLongClickListener((parent, v, position, id) -> {
    ...
    private void loadExpenseList() {
        ...
        Cursor c = db.getTransactionsForUser(userEmail, "expense");
        if (c != null) {
            while (c.moveToNext()) {
    ...
    private void showAddDialog() {
        ...
        builder.setPositiveButton("Save", (dialog, which) -> {
            ...
            long res = db.insertTransaction(userEmail, "expense", amount, today, null, desc);
            if (res != -1) {
    ...
    private void confirmDelete(int trxId) {
        new AlertDialog.Builder(requireContext())
                .setTitle("Delete")
                .setMessage("Delete this expense transaction?")
